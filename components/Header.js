...
const Header = () => {
    ...
    const active= 'text-green-500 transition hover:text-green-500/75 p-3 bg-gray-200 rounded-md'
    const inactive= 'text-gray-500 transition hover:text-green-500/75 '
  if (session) {
    return (
      <>
